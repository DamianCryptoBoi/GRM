...
def instant3d_gs(instant3d_model,
    ...
    image = instant3d_pipe(model=instant3d_model,
                           prompt=prompt,
                           negative_prompt="empty, nothing, false, wrong, negative, not quite right, ugly, blurry, pixelated obscure, unnatural colors, poor lighting, dull, unclear, cropped, lowres, low quality, artifacts, duplicate",
